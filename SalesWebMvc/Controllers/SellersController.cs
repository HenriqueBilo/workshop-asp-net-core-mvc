...
namespace SalesWebMvc.Controllers
{
    public class SellersController : Controller
    {
        ...
        {
            var list = await _sellerService.FindAllAsync(); //Acessa o model
            return View(list);
        }
        ...
        {
            var departments = await _departmentService.FindAllAsync(); //Busca todos departamentos
        ...
        public IActionResult Error(string message)
        {
            var viewModel = new ErrorViewModel
            {
                ...
                //Activity.Current?.Id ?? HttpContext.TraceIdentifier --> Para pegar o id da requisição
            };
